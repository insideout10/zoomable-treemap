...
LayoutHelper.prototype.getAdjustedLayout = function(node) {
  ...
  do {
    ...
    var shrinkedNode = this.aggregateNSmallestTiles(
      node.copy(),
      tilesSortedBySize,
...
LayoutHelper.prototype.aggregateNSmallestTiles = function(
  node,
  tilesSortedBySize,
  numberOfTilesToBeAggregated
) {
  ...
  var tilesToBeAggregated = tilesSortedBySize.slice(
    0,
    numberOfTilesToBeAggregated
  );
